...
var dev = 'src/',
		...
		paths = {
			...
			pages: [
				dev + 'templates/**/*.twig', 
				ignore + 'templates/partials/*.twig',
				ignore + 'templates/modules/*.twig'
			],
			img: dev + 'img/**/*',
			css: dev +'css/*.styl',
			js: dev + 'js/*.js',
...
gulp.task('default', ['templates', 'styleguide', 'sprites', 'fonts', 'vendors', 'styles', 'scripts', 'server', 'watch']); 
// 'sprites', 'fonts', 'vendors',
